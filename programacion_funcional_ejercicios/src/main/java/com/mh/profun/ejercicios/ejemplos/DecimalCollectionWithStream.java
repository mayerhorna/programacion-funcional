package com.mh.profun.ejercicios.ejemplos;
...
/**
 * Imperativo Orientado a Objetos con optimización de Programación Funcional
 * */
public class DecimalCollectionWithStream {

    private List<Double> collection; //Almacena estado
